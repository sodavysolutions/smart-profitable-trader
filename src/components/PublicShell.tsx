...
const funnelNav = [
  { href: "/spt/home#how-it-works", label: "How It Works" },
    ...
    <main className="min-h-screen bg-white">
      <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div className="page-shell flex h-20 items-center justify-between gap-6">
          <Link href="/spt/home" className="rounded-md bg-navy-950 px-3 py-2">
            <Brand />
          </Link>
          ...
          <Link href="/spt/apply" className="rounded-md bg-profit-500 px-4 py-2 text-sm font-bold text-navy-950">
            Apply Now
          </Link>
        </div>
      </header>
