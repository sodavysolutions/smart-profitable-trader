...
export default function PaymentsPage() {
  ...
  return (
    <AdminShell title="Payments and Revenue">
      <Card>
        ...
        <DataTable columns={["Customer", "Service", "Amount", "Method", "Status", "Reference"]} rows={payments.map((payment) => [payment.customer, payment.service, currency(payment.amount), payment.method, <StatusBadge key={payment.reference} value={payment.status} />, payment.reference])} />
      </Card>
    </AdminShell>
  );
}
