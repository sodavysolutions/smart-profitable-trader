  ...
  try {
    ...
    const application = await prisma.application.create({
      data: {
        ...
        accountSize: normalizeText(data.instantFundedAccountSize || data.accountSize),
        startingCapital: normalizeText(data.investmentAmount || data.accountBalance),
        propFirm: normalizeText(data.instantFundedProvider),
