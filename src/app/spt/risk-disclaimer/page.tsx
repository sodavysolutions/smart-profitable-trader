...
export const metadata: Metadata = {
  title: "Risk Disclaimer | Smart Profits Trader",
  description: "Read the Smart Profits Trader risk disclaimer. Trading involves risk and results are not guaranteed."
};
    ...
    <SPTPageShell>
      <section className="page-shell py-16">
        ...
        <div className="mt-6 max-w-4xl space-y-5 leading-7 text-slate-700">
          ...
          <p>Smart Profits Trader does not guarantee profits, returns, pass rates, withdrawals, or funding outcomes. Past performance, examples, testimonials, or dashboard figures do not guarantee future results.</p>
